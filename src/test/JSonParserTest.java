...
public class JSonParserTest extends TestCase {
	...
	@Before
	public void setUp() {
		this.parser = new JSonParser(WEATHER_DATA_FREMONT_JUN_4, 5);
	}
	@Test
	public void testMountainViewThirdDay() throws JSONException {
		assertTrue(parser.getWeatherDataFromJson().length > 1);
	}

//	@Test
//	public void testFremontLastDay() {
//		assertEquals(16.75, this.parser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, 6));
//	}
